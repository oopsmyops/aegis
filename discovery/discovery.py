...
class ClusterDiscovery(LoggerMixin):
    ...
    def _initialize_kubernetes_client(self) -> None:
        ...
        try:
            ...
            raise ClusterDiscoveryError(f"Failed to initialize Kubernetes client: {str(e)}")
    ...
    def discover_cluster(self) -> Dict[str, Any]:
        ...
        try:
            ...
            discovery_data['third_party_controllers'] = self.scan_third_party_controllers()
    ...
    def _discover_basic_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            raise ClusterDiscoveryError(f"Failed to discover basic cluster info: {str(e)}")
