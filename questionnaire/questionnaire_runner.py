...
class QuestionnaireRunner:
    ...
    def run_questionnaire(self) -> GovernanceRequirements:
        ...
        try:
            ...
            if not self.question_bank.validate_question_count():
                raise QuestionnaireError("Invalid question count", 
    ...
    def _ask_registry_list(self, question: Question) -> Dict[str, Any]:
        ...
        while True:
            try:
                ...
                registries = [r.strip() for r in registries_input.split(',') if r.strip()]
                ...
                for registry in registries:
                    if self._validate_registry_format(registry):
                        ...
                        print(f"Warning: '{registry}' may not be a valid registry format")
            ...
            try:
                for label_pair in labels_input.split(','):
                    ...
                    if '=' in label_pair:
                        ...
                        print(f"Warning: Invalid label format '{label_pair}', skipping.")
    ...
    def _ask_resource_limits(self, question: Question) -> Dict[str, Any]:
        ...
        try:
            ...
            if not limits_input:
                ...
                skip = input("Skip resource limits configuration? (y/n): ").strip().lower()
                if skip in ['y', 'yes']:
            ...
            try:
                for limit_pair in limits_input.split(','):
                    ...
                    if '=' in limit_pair:
                        ...
                        print(f"Warning: Invalid limit format '{limit_pair}', skipping.")
    ...
    def _validate_registry_format(self, registry: str) -> bool:
        ...
        if registry.startswith('localhost') or registry.replace('.', '').replace(':', '').isdigit():
            return True
