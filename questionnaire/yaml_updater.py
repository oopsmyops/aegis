...
class YamlUpdater:
    ...
    def append_to_cluster_yaml(self, 
        ...
        try:
            ...
            cluster_data["discovery_metadata"]["questionnaire_timestamp"] = datetime.now().isoformat()
    ...
    def _load_existing_yaml(self, file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if not isinstance(data, dict):
                raise QuestionnaireError("Invalid YAML structure", "Expected dictionary at root level")
    ...
    def _build_governance_section(self, requirements: GovernanceRequirements) -> Dict[str, Any]:
    ...
    def _build_answers_section(self, answers: List[RequirementAnswer]) -> Dict[str, Any]:
    ...
    def _build_configurations_section(self, requirements: GovernanceRequirements) -> Dict[str, Any]:
    ...
    def get_existing_requirements(self, file_path: Optional[str] = None) -> Optional[Dict[str, Any]]:
