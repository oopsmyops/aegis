...
class TestBedrockClient(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertEqual(self.bedrock_client.model_id, 'anthropic.claude-3-sonnet-20240229-v1:0')
    ...
    def test_anthropic_model_request_format(self):
        ...
        result = self.bedrock_client.send_request("Test prompt", max_tokens=1000, temperature=0.2)
