...
class TestOutputManager(unittest.TestCase):
    ...
    def test_organize_policies_by_category(self):
        ...
        organized = self.output_manager.organize_policies_by_category(self.sample_policies)
        ...
        self.assertEqual(security_policy.original_policy.name, "restrict-image-registries")
    ...
    def test_write_policy_files(self):
        ...
        # Organize policies
        organized_policies = self.output_manager.organize_policies_by_category(self.sample_policies)
        ...
        resource_dir = os.path.join(self.temp_dir, "resource-management", "require-pod-resources")
    ...
    def test_sanitize_filename(self):
        ...
        self.assertEqual(
            self.output_manager._sanitize_filename("normal-filename"),
            "normal-filename"
        )
