...
class TestQuestionBank(unittest.TestCase):
    ...
    def test_question_structure(self):
        ...
        for question in questions:
            ...
            self.assertTrue(len(question.text) > 10, "Question text should be descriptive")
    ...
    def test_categories_present(self):
        ...
        expected_categories = {
            "image_security", "resource_management", 
            "security_context", "network_security", "compliance"
        }
    ...
    def test_compliance_frameworks(self):
        ...
        self.assertGreaterEqual(len(frameworks), 5, "Should have at least 5 compliance frameworks")
    ...
    def test_follow_up_questions(self):
        ...
        self.assertGreaterEqual(len(follow_up_questions), 3, "Should have at least 3 follow-up questions")
